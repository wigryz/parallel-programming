package com.wigryz.lab_7_fork.sorting;
...
public class DivideTask extends RecursiveTask<int[]> {
    ...
    protected int[] compute() {
        ...
        DivideTask task1 = new DivideTask(
                Arrays.copyOfRange(arrayToDivide, 0, arrayToDivide.length/2));
        DivideTask task2 = new DivideTask(
                Arrays.copyOfRange(arrayToDivide, arrayToDivide.length/2, arrayToDivide.length));
